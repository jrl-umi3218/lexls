// Time-stamp: <2014-12-02 14:04:40 drdv>
#ifndef TYPEDEFS
#define TYPEDEFS
...
namespace LexLS
{
    ...
    enum RegularizationType
    {
        ...
        REGULARIZATION_R,          // 2
        REGULARIZATION_R_NO_Z,     // 3
        REGULARIZATION_RT_NO_Z,    // 4
        REGULARIZATION_TIKHONOV_1, // 5
        REGULARIZATION_TIKHONOV_2, // 6
        REGULARIZATION_TEST        // 7
    };
